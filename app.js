...
// b) the "correctGuesses" array should have underscores, where each underscore represents an unguessed letter in the "currentWord".
...
// b) In the "handleGuess" function. Check if the guessed letter exists in "currentWord". If it does, update the "correctGuesses" array to replace the appropriate underscores with the guessed letter. If it doesn’t, add the guessed letter to "wrongGuesses" and check if the player has reached the loss condition (too many wrong guesses).
